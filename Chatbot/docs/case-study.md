# Portfolio Case Study: IntelliChat AI FAQ Assistant

## Project summary

I built a deployable FAQ chatbot prototype for IntelliChat Solutions that helps website visitors ask questions about company services, AI chatbot automation, cybersecurity, web development, digital marketing, creative media, and training programs.
...
- IntelliChat services
- AI chatbot automation
- Cybersecurity
- Web development
- Digital marketing
- Creative media production
- IntelliChat training programs
- Contact guidance

If the model cannot find enough relevant information, it avoids guessing and asks the user to try an IntelliChat-related question.
...
- Expand the knowledge base after IntelliChat reviews official service details
