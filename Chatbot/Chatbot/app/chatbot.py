...
CONTACT_SOURCE = {
    "title": "Contact IntelliChat",
    "url": "https://intellichatsolutions.com/contact/",
    "category": "Contact",
}
STOPWORDS = {
    "a",
...
SMALL_TALK_RESPONSES = {
    "greeting": (
        "Hello! I am the IntelliChat AI Assistant. You can ask me about IntelliChat services, "
        "AI chatbots, cybersecurity, web development, digital marketing, creative media, "
        "or training programs."
    ),
    "wellbeing": (
        "I am doing great, thanks for asking. I am ready to help you explore IntelliChat "
        "services or answer quick questions about this prototype."
    ),
    "thanks": "You are welcome. Ask me anything about IntelliChat whenever you are ready.",
    "goodbye": "Goodbye! Feel free to come back if you need more information about IntelliChat.",
}
...
class IntelliChatFAQBot:
    """Small TF-IDF FAQ assistant over curated IntelliChat public website content."""
    ...
    def answer(self, message: str) -> dict[str, Any]:
        ...
        if not cleaned:
            return {
                "answer": "Ask me about IntelliChat services, training programs, AI automation, cybersecurity, web development, or digital marketing.",
                "confidence": 0.0,
                "sources": [],
        ...
        if best_score < 0.06:
            return {
                "answer": (
                    "I do not have enough information about that in my current IntelliChat knowledge base. "
                    "For the most accurate answer, please contact the IntelliChat team through the official "
    ...
    def suggested_questions(self, category: str | None = None) -> list[str]:
        ...
        fallback = [
            "What services does IntelliChat offer?",
            "Can IntelliChat build an AI chatbot?",
            "Does IntelliChat provide cybersecurity services?",
            "What is the IntelliChat Digital Community?",
        ]
...
@lru_cache(maxsize=1)
def get_bot() -> IntelliChatFAQBot:
    root = Path(__file__).resolve().parents[1]
    return IntelliChatFAQBot(root / "data" / "intellichat_knowledge.json")